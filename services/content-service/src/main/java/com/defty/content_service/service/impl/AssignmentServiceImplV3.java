...
//public class AssignmentServiceImplV2 implements AssignmentService {
...
//                    .findByModuleIdInAndClassIdInAndChecked(moduleIds, assignRequest.getClassIds(), isTestAssignment);
//            if (!existing.isEmpty()) {
...
//
//        List<Long> assignmentIds = assignmentClassesForClass.stream()
//                .map(ac -> ac.getAssignment().getId())
//                .distinct()
//                .toList();
//        List<Assignment> assignments = assignmentRepository.findByIdInAndIsActive(assignmentIds, 1);
//
...
//                .toList();
//
//        List<AssignmentClassResponse> assignmentClassResponses = new ArrayList<>(assignmentClassesForClass.size());
//        Set<Long> moduleIdsAdded = new HashSet<>();
//
//        List<ModuleResponse> mergedModules = new ArrayList<>(commonModules);
//
//        for (AssignmentClass ac : assignmentClassesForClass) {
//            List<ModuleResponse> moduleResponses = List.of();
//            if (ac.getModule() != null) {
//                ModuleResponse mr = ModuleResponse.builder()
...
//                        .build();
//
//                moduleResponses = List.of(mr);
//
//                if (!moduleIdsAdded.contains(mr.getId())) {
//                    mergedModules.add(mr);
//                    moduleIdsAdded.add(mr.getId());
//                }
//            }
//
//
//            assignmentClassResponses.add(
//                    AssignmentClassResponse.builder()
//                            .id(ac.getId())
...
//            assignment.setAssignmentCode(sb.toString() + "-" + randomNum);
//        }
//
...
//            }
//
//            if (moduleReq.getTypeUml() == null || moduleReq.getTypeUml().isEmpty()) {
//                throw new IllegalArgumentException("Module must have a TypeUml");
//            }
//            try {
//                TypeUml typeUmlEnum = TypeUml.valueOf(moduleReq.getTypeUml().toUpperCase());
//                module.setTypeUml(typeUmlEnum);
//            } catch (IllegalArgumentException ex) {
//                throw new NotFoundException("TypeUml enum not found: " + moduleReq.getTypeUml());
//            }
//
...
//                        .moduleDescription(m.getModuleDescription())
//                        .solutionCode(m.getSolutionCode())
//                        .typeUml(m.getTypeUml() != null ? m.getTypeUml().name() : null)
//                        .build())
//                .toList()
//                : List.of();
//
...
//                .typeUml(module.getTypeUml() != null ? module.getTypeUml().name() : null)
//                .build();
//    }
//
//}